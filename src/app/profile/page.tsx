        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 space-y-6 max-w-5xl mx-auto w-full">
          <div className="flex items-center justify-between gap-3 flex-wrap">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">Staff Profile</h1>
            ...
            {isAdmin && (
              <Link
                ...
                className="flex items-center gap-1.5 text-xs font-bold px-3 py-2 rounded-xl bg-amber-500/15 text-amber-300 border border-amber-500/30"
              >
          ...
          {canClaimAdmin && (
            <div className="p-4 rounded-2xl border border-amber-500/30 bg-amber-500/10 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <button
                ...
                className="text-xs font-bold px-4 py-2 rounded-xl bg-amber-500 text-slate-950 shrink-0"
              >
                Become Admin
              </button>
            </div>
